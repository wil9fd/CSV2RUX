...
formatting differences.''')
    ...
    def selectInfile(self):
        ...
        outputFile = Path(os.path.dirname(str(inputPath)) + '\\' + inputPath.stem + '.rux')
    ...
    def delimiter_error(self):    
        self.warning_dialog = PyQt5.QtWidgets.QMessageBox()
        self.warning_dialog.setIcon(PyQt5.QtWidgets.QMessageBox.Warning)
        ...
        self.warning_dialog.addButton(PyQt5.QtWidgets.QPushButton('Continue'), PyQt5.QtWidgets.QMessageBox.YesRole)
        self.warning_dialog.addButton(PyQt5.QtWidgets.QMessageBox.Close)
    ...
    def file_error(self):
        self.ferror_dialog = PyQt5.QtWidgets.QErrorMessage()
        self.ferror_dialog.setWindowTitle("Error")
        self.ferror_dialog.showMessage('ERROR: Filename cannot be found')
        
    def general_error(self):
        self.gerror_dialog = PyQt5.QtWidgets.QMessageBox()
        self.gerror_dialog.setIcon(PyQt5.QtWidgets.QMessageBox.Critical)
        ...
        self.gerror_dialog.setDetailedText(traceback.format_exc())
